...
const students = {
    Luke: "Wuthering Heights",
    EJ: "Sinners",
    Katie: "Zootopia",
    Grace: "Bugonia",
    Mohammed: "The Rip",
    Gavin: "Shelter",
    Thomas: "One Battle After Another",
    Len: "Mary Supreme",
    Saeed: "Train Dreams",
    Quan: "If I had Legs I'd Kick You", 
    Temitayo: "Cover Up"
}

var results = Object.entries(students).filter(([k, v]) => v === "Wuthering Heights");
results = Object.entries(students).filter(([k, v]) => k.charAt(0) === "S");

const things = [4, 'Alex', 10.4, 'Silvana', 'Foster', { Michael: 'Vincent' }];
